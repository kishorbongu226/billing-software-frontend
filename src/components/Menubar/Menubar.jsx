        ...
        <ul className="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
          <li className="nav-item dropdown">
            <a
              ...
              id="navDropdown" // id matches aria-labelledby below
              role="button"
            ...
            <ul
              ...
              aria-labelledby="navDropdown" // match the id above
            >
              <li>
              ...
              <li>
                {/* Use a button for actions that don't navigate to another page */}
